                                ...
                                <tr>
                                    <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                        <div align="center" class="alignment" style="line-height:10px"><a
                                                    ...
                                                    target="_blank"><img
                                                        src="{{asset('assets/account-verified-vector.png') }}"
                                        ...
                                        <div style="font-family: Arial, sans-serif">
                                            <div class=""
                                                ...
                                                <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                    <span style="font-size:24px;color:#2b303a;"><strong>ACCOUNT VERIFIED</strong></span>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div style="font-family: sans-serif">
                                            <div class=""
                                                ...
                                                <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
                                                    <span style="font-size:14px;"><br style="color:#808389;">Your registration was successfully approved by CardX.<br/> Let's Trade your cards. </span></span>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div align="center" class="alignment"><!--[if mso]>
                                            ...
                                            <![endif]--><a href="{{ $url?? 'URL' }}"
                                                        ...
                                                        style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:1px;"><span
                                                            dir="ltr"
                                                            style="margin: 0; word-break: break-word; line-height: 32px;"><strong>START TRADING</strong></span></span></a>
